...
By default, a build process involving a [conda](https://docs.conda.io/en/latest/) environment is supported.
  ...
  - navigate into your project directory (filter_mis_output)
  - create the `conda` environment for installation as follows:
  
     `conda env create -f environment.yaml`
  - activate the conda environment:
  
     `conda activate filter_mis_output-env`
  ...
  - run `configure`:
	 ...
	 `./configure --with-boost=/path/to/miniconda3/envs/filter_mis_output-env --with-boost-libdir=/path/to/miniconda3/envs/filter_mis_output-env/lib`
